...
import kr.ac.hansung.remoteDesktop.window.dialog.AskFileTransferDialog;
...
public class OnFileReceivedListener implements FileServer.OnFileReceivedListener {
    JFrame hostWindow;
